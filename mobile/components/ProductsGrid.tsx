  ...
  const renderProduct = ({ item: product }: { item: Product }) => (
    ...
    >
      <View className="relative">
        <Image source={{ uri: product.images[0] }} className="w-full h-44 bg-background-lighter" resizeMode="cover" />
      ...
      <View className="p-3">
        ...
        <View className="flex-row items-center mb-2">
          ...
          <Text className="text-text-primary text-xs font-semibold ml-1">{product.averageRating.toFixed(1)}</Text>
